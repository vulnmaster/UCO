...
ex:CrossPlatformCorrelation rdf:type icac-platforms:CrossPlatformEvidence ;    icac-platforms:platformsInvestigated 3 ;    icac-platforms:coordinatedBy ex:IllinoisICACtaskForce .```### Buffalo/Vermont Interstate Transportation Case```turtle@prefix icac-multi: <https://ontology.unifiedcyberontology.org/icac/multi-jurisdiction#> .@prefix icac-grooming: <https://ontology.unifiedcyberontology.org/icac/grooming#> .@prefix icac-platforms: <https://ontology.unifiedcyberontology.org/icac/platforms#> .# Interstate Transportation Offenseex:BuffaloVermontCase rdf:type icac-multi:InterstateTransportationOffense ;    icac-multi:transportationIntent "sexual_activity" ;    icac-multi:statesCrossed 2 ;    icac-multi:crossingDocumentation "witness_testimony" ;    icac-multi:jurisdictionTriggerType "interstate_transport" .# Anonymous Platform Contactex:AnonymousChat rdf:type icac-platforms:AnonymousChatPlatform ;    icac-platforms:allowsAnonymousChat true ;    icac-platforms:guestAccountsAllowed true ;    icac-platforms:ageVerificationRequired false .ex:InitialContact rdf:type icac-grooming:AnonymousPlatformContact ;    icac-grooming:platformAnonymityLevel "full_anonymous" ;    icac-grooming:identityVerificationRequired false ;    icac-grooming:primaryPlatform ex:AnonymousChat .# Online-to-Offline Progressionex:OnlineToOffline rdf:type icac-grooming:OnlineToOfflineProgression ;    icac-grooming:progressionDuration 14 ;    icac-grooming:patternConfidence 0.95 .ex:PhysicalMeeting rdf:type icac-grooming:PhysicalMeetingArrangement ;    icac-grooming:meetingLocationSpecified true .ex:InterstateTransport rdf:type icac-grooming:InterstateTransportPlan ;    icac-grooming:crossesStateBoundaries true .# State Line Crossingex:StateCrossing rdf:type icac-multi:InterstateVictimTransport ;    icac-multi:transportationMethod "vehicle" ;    icac-multi:statesCrossed 2 ;    icac-multi:originatingState ex:BuffaloNY ;    icac-multi:destinationState ex:Vermont .# Federal Jurisdiction Triggerex:FederalTrigger rdf:type icac-multi:FederalJurisdictionTrigger ;    icac-multi:jurisdictionTriggerType "interstate_transport" .# Multi-Jurisdictional Investigationex:MultiJurisdictionalInvestigation rdf:type icac-multi:MultiJurisdictionalInvestigation ;    icac-multi:investigationScope "interstate" ;    icac-multi:jurisdictionCount 3 ;    icac-multi:agencyCount 4 ;    icac-multi:crossesBorders true ;    icac-multi:coordinationMechanism "joint_operation" .```### Hartford/Vermont Production Case with Image Modification```turtle@prefix icac-production: <https://ontology.unifiedcyberontology.org/icac/production#> .@prefix icac-custodial: <https://ontology.unifiedcyberontology.org/icac/custodial#> .@prefix icac-physical: <https://ontology.unifiedcyberontology.org/icac/physical#> .@prefix icac-sentencing: <https://ontology.unifiedcyberontology.org/icac/sentencing#> .# Production Case with Image Modificationex:HartfordCase rdf:type icac-production:ProductionOffense ;    icac-production:productionMethod "photography_with_modification" ;    icac-production:victimCount 1 ;    icac-production:producedAt ex:HartfordApartment .# Image Post-Processing (NEW CLASS)ex:ImageModification rdf:type icac-production:ImagePostProcessing ;    icac-production:modificationCount 5 ;    icac-production:modificationSoftware "mobile_photo_editor" ;    icac-production:originalImages ex:OriginalPhotos ;    icac-production:modifiedImages ex:ModifiedPhotos .# Text Overlay (NEW CLASS)ex:TextOverlay rdf:type icac-production:TextOverlay ;    icac-production:textType "victim_name_and_slang" ;    icac-production:textContent "victim first name + slang term" ;    icac-production:textPlacement "overlay_on_image" .# Residential Proximity Access (NEW CLASS)ex:ProximityAccess rdf:type icac-custodial:ResidentialProximityAccess ;    icac-custodial:proximityType "same_floor" ;    icac-custodial:buildingType "apartment_building" ;    icac-custodial:accessFrequency "regular" .# Neighbor Relationship (NEW CLASS)ex:NeighborRelation rdf:type icac-custodial:NeighborRelationship ;    icac-custodial:relationshipType "neighbor" ;    icac-custodial:residentialProximity "same_floor" ;    icac-custodial:trustLevel "minimal" ;    icac-custodial:accessLevel "unsupervised_opportunity" .# Identifying Tattoo (NEW CLASS)ex:DistinctiveTattoo rdf:type icac-physical:Tattoo ;    icac-physical:tattooLocation "arm" ;    icac-physical:tattooDescription "distinctive identifying design" ;    icac-physical:identificationValue "high" ;    icac-physical:visibleInEvidence true .# Conditions of Release Violation (NEW CLASS)ex:ReleaseViolation rdf:type icac-sentencing:ConditionsOfReleaseViolation ;    icac-sentencing:violationType "new_federal_offense" ;    icac-sentencing:priorCharge ex:StateLewdnessCharge ;    icac-sentencing:aggravatingFactor true .# State to Federal Escalation (NEW CLASS)ex:StateToFederalEscalation rdf:type icac-sentencing:StateToFederalEscalation ;    icac-sentencing:stateCharge "Lewd and Lascivious Conduct" ;    icac-sentencing:federalCharge "Production of Child Sexual Abuse Materials" ;    icac-sentencing:escalationReason "federal_jurisdiction_production" .```## SPARQL Query Examples

### Production Case Analytics
```sparql
PREFIX icac: <https://ontology.unifiedcyberontology.org/icac#>
PREFIX icac-multi: <https://ontology.unifiedcyberontology.org/icac/multi-jurisdiction#>
PREFIX icac-sentencing: <https://ontology.unifiedcyberontology.org/icac/sentencing#>

SELECT ?investigation ?agencyCount ?sentenceLength WHERE {
    ?investigation rdf:type icac:Investigation ;
        icac-multi:agencyCount ?agencyCount .
    ?sentence icac-sentencing:sentenceLength ?sentenceLength .
} ORDER BY DESC(?sentenceLength)
```
...
WHERE {
    ?tacticalOp icac-tactical:operationOutcome ?tacticalOutcome .
    ?undercoverOp icac-undercover:operationOutcome ?undercoverOutcome .
}
```
